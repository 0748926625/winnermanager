...
const SUPABASE_URL = 'https://zvkawvlhmqqmxilbbqms.supabase.co';
const SUPABASE_ANON_KEY = 'sb_publishable_hXyLca3gTotTg9VzHN_Qbw_WnJJvDvG';
...
Généré par Winner Express - ${dateObj.toLocaleDateString('fr-FR')} ${heure}`;
    ...
    // Méthodes Supabase pour la synchronisation
    initSupabase() {
